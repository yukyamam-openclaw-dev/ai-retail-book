...
- **Format**: Write in modular Markdown files.
- **Final Stage**: Consolidate all MD files and convert to Kindle-compatible format.
- **Referencing**: This file MUST be loaded as the primary source of truth before writing any section.
